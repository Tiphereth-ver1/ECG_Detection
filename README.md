...
7. Remove QRS points inside noisy windows.
...
### Attempt 2 branch — performance summary

Across all **35** training records, aggregated metrics against expert annotations
(with **50 ms** tolerance) are: **Sensitivity 0.9961**, **PPV 0.9947**, **F1 0.9954**
(total **1,117,730** TP, **5,926** FP, **4,322** FN). Most records score **F1 ≥ 0.997**;
...
Compared with the previous polarity/refinement version, this cleanup has a very
small F1 improvement and fewer false positives. Compared with the earlier
`~0.9933` QRS version, it is clearly better. Compared with the original
baseline around `0.973`, it is much better.
